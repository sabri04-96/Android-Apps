...
public class AdminAdapter  extends RecyclerView.Adapter<AdminAdapter.ViewHolder> {
    ...
    public AdminAdapter(Context c, List<Patient> patientList)
    {
        this.context=c;
    ...
    public AdminAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.admin_items,parent,false);
    ...
    public void onBindViewHolder(AdminAdapter.ViewHolder holder, int position) {
        ...
        holder.update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentX = new Intent(v.getContext(),FirstUpdate .class);
